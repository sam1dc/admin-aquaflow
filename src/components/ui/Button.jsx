...
export const Button = ({ children, variant = 'primary', size = 'md', className = '', ...props }) => {
  ...
  const variantClasses = {
    ...
    danger: 'bg-status-error-dark text-white hover:bg-status-error-dark/80 hover:shadow-[0_0_15px_rgba(231,76,60,0.3)] focus:ring-status-error/50 active:scale-[0.97]',
